...
public class SearchQuery {
	...
	public String toString() {
		return "SearchQuery [origin=" + origin + ", destination=" + destination + ", flightNumber=" + flightNumber
				+ ", flightDate=" + flightDate + ", travellers=" + travellers + ", passenger=" + passenger
				+ ", bookingId=" + bookingId + ", coPassengers=" + coPassengers + "]";
	}
